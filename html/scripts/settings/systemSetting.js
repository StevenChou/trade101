    ...
    kiosk.wording = {
        ...
        5: {
            ...
            remind: {
                ...
                remindTitle2: 'ก่อนที่จะเดินออกจากเครื่องคืนภาษี โปรดสำรวจว่าท่านได้รับแบบฟอร์มขอคืนภาษีแล้ว',
                remindTitle3: 'โปรดเตรียมเอกสารขาเข้าฉบับเดิมของคุณ (หนังสือเดินทาง / บัตรผู้โดยสาร) และใบแจ้งหนี้การซื้อเพื่อเริ่มยื่นเรื่องการคืนภาษี',
        ...
        6: {
            ...
            remind: {
                remindTitle1: 'انتبه',
                remindTitle2: 'يجب عليك أن تحصل على الأوراق لاسترداد الضريبة قبل مغادرة آلة استرداد الضريبة',
                remindTitle3: 'يرجى الاستعداد لوثائقك الأصلية للدخول(جواز السفر، وأذون الدخول لجمهورية الصين) وفاتورات البضائع لإجراء استرداد الضريبة',
                btTitle: 'التأكد، ابدأ بإجراء استرداد الضريبة',
                toSelectDoc: 'selectDoc'
            },
            selectDoc: {
                selectTitle: 'يرجى الاختيار وثائقك التي تستخدمها لدخول تايوان في هذه المرة',
                passport: 'جواز السفر',
            ...
            scanPassport: {
                ...
                scanError: 'لا نستطيع تحديد هذا جواز السفر، يرجى إجراء المسح الضوئي مرة أخرى',
                toError: 'error',
                toPreScanQR: 'preScanQRcode',
                scanPassportLoading: '護照掃描中<div id="circleG"><div id="circleG_1" class="circleG"></div><div id="circleG_2" class="circleG"></div><div id="circleG_3" class="circleG"></div></div>',
                passportCerting: '資料驗證中<div id="circleG"><div id="circleG_1" class="circleG"></div><div id="circleG_2" class="circleG"></div><div id="circleG_3" class="circleG"></div></div>',
            ...
            scanPermit: {
                scanPermitTitle: 'يرجى  إجراء المسح الضوئي للشفرة الشريطية على أذون الدخول لجمهورية الصين',
                scanError: 'لا نستطيع تحديد هذه أذون الدخول لجمهورية الصين، يرجى إجراء المسح الضوئي مرة أخرى',
                toError: 'error',
                toPreScanQR: 'preScanQRcode',
                putPermit: '請放置入臺證',
                permitCerting: '資料驗證中<div id="circleG"><div id="circleG_1" class="circleG"></div><div id="circleG_2" class="circleG"></div><div id="circleG_3" class="circleG"></div></div>',
            ...
            scanQRcode: {
                scanQRcodeTitle1: 'يرجى إجراء المسح الضوئي لشفرة الشريطية على قاتورات البضائع لك',
                ...
                scanQRError1: 'لا يمكن استرداد الضريبة باستخدام هذه الفاتورة، يرجى إجراء المسح الضوئي للفاتورات الأخرى',
                scanQRError2: '請掃描下一張',
                scanQRErrorDup: '發票重複輸入，<br>請掃描下一張',
                scanQRcodeLoading: '資料查詢中<div id="circleG"><div id="circleG_1" class="circleG"></div><div id="circleG_2" class="circleG"></div><div id="circleG_3" class="circleG"></div></div>',
                toDetail: 'detail',
            ...
            success: {
                ...
                successTitle3: 'إذا لا تكمل كل الإجراءات لاسترداد الضريبة، لا يمكنك أن تستلم الأموال التي تم الاسترداد',
                successTitle4: '',
                toHomeText: 'العودة إلى الصفحة الرئيسية للخدمة',
            },
        },
        ...
        10: {
            ...
            remind: {
                ...
                remindTitle3: 'Vui lòng chuẩn bị tài liệu nhập cảnh(hộ chiếu/giấy nhập cảnh Đài Loan) và hóa đơn mua hàng để bắt đầu hoàn thuế',
                btTitle: 'Xác nhận,Bắt đầu hoàn thuế',
                toSelectDoc: 'selectDoc'
            },
            selectDoc: {
                selectTitle: 'Vui lòng chọn những giấy tờ liên quan trong lần nhập cảnh tới Đài Loan',
                passport: 'Hộ chiếu',
