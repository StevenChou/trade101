  ...
  var StartMainApp = function() {
    ...
    var mainApp = new Vue({
      ...
      data: {
        ...
        currentPage: undefined, //'component-mainMenu-main',
        currentModel: undefined, // viewModel[kiosk.culture]['mainMenu'],
        currentNavBar: undefined, // 'component-mainMenu-navBar',
      ...
      created: function() {
        ...
        this.axiosInstances.ap101 = axios.create({
          baseURL: 'http://172.16.41.134:7066'
        });

        this.axiosInstances.apTrade = axios.create({
          baseURL: 'https://vuejs-http-33dc8.firebaseio.com/'
        });
      },
      destroyed: function() {
        console.log('>>> mainApp destroyed!!');
      }
    });
